...
Game = ig.Game.extend({
	...
	init: function() {
		...
		this.spawnEntity( 'EntityNode', 128, 384, { team: Color.yellow, data: 35, threads: 2 } );

		this.spawnEntity( 'EntityNode', 256+256-128, 384-128 );
		this.spawnEntity( 'EntityNode', 1024-512, 384+128, { team: Color.purple } );

		this.spawnEntity( 'EntityNode', 1024-128, 384, { team: Color.purple, virus: 50, data: 70, threads: 3 } );
	},
