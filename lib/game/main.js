...
Game = ig.Game.extend({
	...
	init: function() {
		...
		this.spawnEntity( 'EntityNode', 1024*0, 1024*0 );
		this.spawnEntity( 'EntityNode', 1024*1, 1024*0 );
		this.spawnEntity( 'EntityNode', 1024*2, 1024*0 );
		this.spawnEntity( 'EntityNode', 1024*3, 1024*0 );
		this.spawnEntity( 'EntityNode', 1024*0, 1024*1 );
		this.spawnEntity( 'EntityNode', 1024*1, 1024*1, { team: Color.green, threads: 1, data: 30 } );
		this.spawnEntity( 'EntityNode', 1024*2, 1024*1 );
		this.spawnEntity( 'EntityNode', 1024*3, 1024*1 );
		this.spawnEntity( 'EntityNode', 1024*0, 1024*2 );
		this.spawnEntity( 'EntityNode', 1024*1, 1024*2 );
		this.spawnEntity( 'EntityNode', 1024*2, 1024*2 );
		this.spawnEntity( 'EntityNode', 1024*3, 1024*2 );
		this.spawnEntity( 'EntityNode', 1024*0, 1024*3 );
		this.spawnEntity( 'EntityNode', 1024*1, 1024*3 );
		this.spawnEntity( 'EntityNode', 1024*2, 1024*3 );
		this.spawnEntity( 'EntityNode', 1024*3, 1024*3, { team: Color.turquoise, threads: 1, data: 30 }  );
	},
