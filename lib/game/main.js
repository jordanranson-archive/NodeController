...
NodeController = ig.Game.extend({
	...
	init3d: function() {
        ...
        this.rotation.y = (0).toRad();

        // game area
        this.gameobject = new THREE.Object3D();
	    this.gameobject.rotation.x = this.rotation.x;
	    this.gameobject.rotation.y = this.rotation.y;
	    ...
	    var h = (ig.game.renderer.domElement.height/4)*0.1;
	    var x = ((ig.game.renderer.domElement.width*0.5)/4)-(w*0.5);
	    var y = ((ig.game.renderer.domElement.height*0.5)/4)-(h*0.5);
	    this.viewport = {};
	    ...
	    // left
    	plane = new THREE.Mesh(new THREE.PlaneGeometry( w, 1000 ), new THREE.MeshBasicMaterial({ color: 0x222222 }));
		plane.position.set( -x, 0, 0.2 );
	    ...
	    // top
    	plane = new THREE.Mesh(new THREE.PlaneGeometry( 1000, h ), new THREE.MeshBasicMaterial({ color: 0x222222 }));
		plane.position.set( 0, y, 0.2 );
	    this.bezel.add( plane );
	    ...
	    // border 	    
	    w = (ig.game.renderer.domElement.width/4)*0.1;
	    x = ((ig.game.renderer.domElement.width*0.5)/4)-(w*0.5);
	    material = new THREE.LineBasicMaterial({ color: 0x666666 });
	    geometry = new THREE.Geometry();
		geometry.vertices.push( new THREE.Vector3(-x+(w*0.5), y-(h*0.5), 0.3) );
		geometry.vertices.push( new THREE.Vector3(x-(w*0.5), y-(h*0.5), 0.3) );
		geometry.vertices.push( new THREE.Vector3(x-(w*0.5), -y+(h*0.5), 0.3) );
		geometry.vertices.push( new THREE.Vector3(-x+(w*0.5), -y+(h*0.5), 0.3) );
		geometry.vertices.push( new THREE.Vector3(-x+(w*0.5), y-(h*0.5), 0.3) );
