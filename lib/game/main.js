...
Game = ig.Game.extend({
	...
	init: function() {
		...
		this.spawnEntity( 'EntityNode', 128+25, 128+25, { virus: 1, vaccine: 1, data: 5, threads: 0 } );
		this.spawnEntity( 'EntityNode', 896-100, 128+100, { virus: 100, vaccine: 100, data: 100, threads: 0 } );
