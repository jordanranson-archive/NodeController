...
Game = ig.Game.extend({
	...
	init: function() {
		...
		this.spawnEntity( 'EntityNode', 0, 0, { team: Color.orange, virus: 25, data: 25, vaccine: 25, threads: 3 } );
		this.spawnEntity( 'EntityNode', 1024, 768, { team: Color.orange, virus: 25, data: 25, vaccine: 25, threads: 3 } );
	},
	...
	update: function() {
		...
		this.zoom = this.zoom.limit( 0.1, 1 );
		this.parent();
	},
