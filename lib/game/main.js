...
NodeController = ig.Game.extend({
	...
	init: function() {
        ...
        this.spawnEntity( 'Entity3d', 5*16, 0, { team: (Math.random()*7<<0) } );
        this.spawnEntity( 'Entity3d', -5*16, 0, { team: (Math.random()*7<<0) } );
        this.spawnEntity( 'Entity3d', 0, 5*16, { team: (Math.random()*7<<0) } );
        this.spawnEntity( 'Entity3d', 0, -5*16, { team: (Math.random()*7<<0) } );
        this.spawnEntity( 'Entity3d', 5*16, -5*16, { team: (Math.random()*7<<0) } );
        this.spawnEntity( 'Entity3d', -5*16, 5*16, { team: (Math.random()*7<<0) } );
        this.spawnEntity( 'Entity3d', 5*16, 5*16, { team: (Math.random()*7<<0) } );
        this.spawnEntity( 'Entity3d', -5*16, -5*16, { team: (Math.random()*7<<0) } );
