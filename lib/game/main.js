...
Game = ig.Game.extend({
	...
	init: function() {
		...
		this.spawnEntity( 'EntityNode', 0, 0, { team: Color.orange, virus: 5, data: 15, vaccine: 5, threads: 3 } );
	},
	...
	update: function() {
		...
		this.mouse.x = ig.input.mouse.x/this.zoom;
		this.mouse.y = ig.input.mouse.y/this.zoom;
