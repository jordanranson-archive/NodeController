...
NodeController = ig.Game.extend({
	...
	init: function() {
        ...
        // spawn entities
        this.spawnEntity( 'Entity3d', 0, 0, { team: 0 } );
        this.spawnEntity( 'Entity3d', 5*16, 0, { team: (Math.random()*6<<0)+1, nodeSize: (Math.random()*3<<0) } );
        this.spawnEntity( 'Entity3d', -5*16, 0, { team: (Math.random()*6<<0)+1, nodeSize: (Math.random()*3<<0) } );
        this.spawnEntity( 'Entity3d', 0, 5*16, { team: (Math.random()*6<<0)+1, nodeSize: (Math.random()*3<<0) } );
        this.spawnEntity( 'Entity3d', 0, -5*16, { team: (Math.random()*6<<0)+1, nodeSize: (Math.random()*3<<0) } );
        this.spawnEntity( 'Entity3d', 5*16, -5*16, { team: (Math.random()*6<<0)+1, nodeSize: (Math.random()*3<<0) } );
        this.spawnEntity( 'Entity3d', -5*16, 5*16, { team: (Math.random()*6<<0)+1, nodeSize: (Math.random()*3<<0) } );
        this.spawnEntity( 'Entity3d', 5*16, 5*16, { team: (Math.random()*6<<0)+1, nodeSize: (Math.random()*3<<0) } );
        this.spawnEntity( 'Entity3d', -5*16, -5*16, { team: (Math.random()*6<<0)+1, nodeSize: (Math.random()*3<<0) } );
	...
	init3d: function() {
	    ...
	    geometry.vertices.push( new THREE.Vector3(40*16, 0, 0.5) );
	    geometry.vertices.push( new THREE.Vector3(40*16, 40*16, 0.5) );
	    geometry.vertices.push( new THREE.Vector3(0, 40*16, 0.5) );
	    geometry.vertices.push( new THREE.Vector3(0, 0, 0.5) );
