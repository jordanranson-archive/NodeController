...
NodeController = ig.Game.extend({
	...
	init: function() {
        ...
        this.spawnEntity( 'Entity3d', 5*16, 0, { team: (Math.random()*6<<0)+1, nodeSize: (Math.random()*3<<0), firewall: Math.random()>0.5 } );
        this.spawnEntity( 'Entity3d', -5*16, 0, { team: (Math.random()*6<<0)+1, nodeSize: (Math.random()*3<<0), firewall: Math.random()>0.5 } );
        this.spawnEntity( 'Entity3d', 0, 5*16, { team: (Math.random()*6<<0)+1, nodeSize: (Math.random()*3<<0), firewall: Math.random()>0.5 } );
        this.spawnEntity( 'Entity3d', 0, -5*16, { team: (Math.random()*6<<0)+1, nodeSize: (Math.random()*3<<0), firewall: Math.random()>0.5 } );
        this.spawnEntity( 'Entity3d', 5*16, -5*16, { team: (Math.random()*6<<0)+1, nodeSize: (Math.random()*3<<0), firewall: Math.random()>0.5 } );
        this.spawnEntity( 'Entity3d', -5*16, 5*16, { team: (Math.random()*6<<0)+1, nodeSize: (Math.random()*3<<0), firewall: Math.random()>0.5 } );
        this.spawnEntity( 'Entity3d', 5*16, 5*16, { team: (Math.random()*6<<0)+1, nodeSize: (Math.random()*3<<0), firewall: Math.random()>0.5 } );
        this.spawnEntity( 'Entity3d', -5*16, -5*16, { team: (Math.random()*6<<0)+1, nodeSize: (Math.random()*3<<0), firewall: Math.random()>0.5 } );*/
    ...
    loadLevel: function( image ) {
        ...
        for( var y = 0; y < this.currLevelData.nodeMap.length; y++ ) {
            for( var x = 0; x < this.currLevelData.nodeMap[y].length; x++ ) {
                ...
                if( node !== '.' ) {
                    __cnt++;
                    this.spawnEntity( 'Entity3d', x*16-(20*16), y*16-(20*16), { team: 0 } );
                }
            }
        }
