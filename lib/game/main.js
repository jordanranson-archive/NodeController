...
NodeController = ig.Game.extend({
	...
	init: function() {
        ...
        this.spawnEntity( 'Entity3d', 5*16, 0, { team: (Math.random()*6<<0)+1 } );
        this.spawnEntity( 'Entity3d', -5*16, 0, { team: (Math.random()*6<<0)+1 } );
        this.spawnEntity( 'Entity3d', 0, 5*16, { team: (Math.random()*6<<0)+1 } );
        this.spawnEntity( 'Entity3d', 0, -5*16, { team: (Math.random()*6<<0)+1 } );
        this.spawnEntity( 'Entity3d', 5*16, -5*16, { team: (Math.random()*6<<0)+1 } );
        this.spawnEntity( 'Entity3d', -5*16, 5*16, { team: (Math.random()*6<<0)+1 } );
        this.spawnEntity( 'Entity3d', 5*16, 5*16, { team: (Math.random()*6<<0)+1 } );
        this.spawnEntity( 'Entity3d', -5*16, -5*16, { team: (Math.random()*6<<0)+1 } );
