...
Entity3d = ig.Entity.extend({
    ...
    init3d: function() {
        ...
        for( var i = 0; i < 25; i++ ) {
            ...
            mesh.overdraw = true;
            mesh.position.x = (this.pos.x + this.size.x*0.5) + (Math.random()*16-8);
            mesh.position.y = -(this.pos.y + this.size.y*0.5) + (Math.random()*16-8);
            mesh.position.z = 16 + (Math.random()*16-8);
