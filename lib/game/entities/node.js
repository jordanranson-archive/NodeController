...
EntityNode = ig.Entity.extend({
	...
	update: function() {
		...
		ig.show('timer',this.travelTimer.delta().toFixed(1));
	...
	draw: function() {
		...
		ig.system.context.translate( 
			(ig.system.width-(ig.system.width*ig.game.zoom))*0.5,  
			(ig.system.height-(ig.system.height*ig.game.zoom))*0.5 
		);
		ig.system.context.scale( ig.game.zoom, ig.game.zoom );
