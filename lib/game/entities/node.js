...
EntityNode = ig.Entity.extend({
	...
	update: function() {
		...
		this.uiLastAlpha = this.uiAlpha;
		if( this.uiAlpha < this.uiCurAlpha ) this.uiAlpha += Math.abs(this.uiCurAlpha-this.uiAlpha)*0.1;
		else if( this.uiAlpha > this.uiCurAlpha ) this.uiAlpha -= Math.abs(this.uiCurAlpha-this.uiAlpha)*0.1;
		if( (this.lastVal < this.uiCurAlpha && this.uiAlpha >= this.uiCurAlpha) ||
		    (this.lastVal > this.uiCurAlpha && this.uiAlpha <= this.uiCurAlpha) ) {
			this.uiAlpha = this.uiCurAlpha;
		}
	...
	draw: function() {
		...
		if( this.threadMenu ) {
			...
			ig.system.context.globalAlpha = 0.45;
