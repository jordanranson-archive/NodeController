...
EntityNode = ig.Entity.extend({
	...
	update: function() {
		...
		if( this.threads > 0 && this.productionTimer.delta() > this.efficiency ) {
	...
	drawUI: function() {
		...
		// draw data value 
			...
			ig.system.context.globalAlpha = this.globalAlpha*ig.game.zoom.limit( 0.25, 0.5 ).map( 0.25, 0.5, this.uiCurAlpha, 1 );
