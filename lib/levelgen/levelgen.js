...
lg.Util.drawTilemap = function( map ) {
	...
	for( var y = 0; y < map.length; y++ ) {
		for( var x = 0; x < map[y].length; x++ ) {
			...
			if( tile === '0' ) context.fillRect( x*ts, y*ts+8+1, ts, 3 );
			if( tile === '11' ) {
				context.fillRect( x*ts+8, y*ts+8+1, ts-8, 3 );
			}
			if( tile === '12' ) {
				context.fillRect( x*ts, y*ts+8+1, ts-8, 3 );
			}
			if( tile === '1' ) context.fillRect( x*ts+8+1, y*ts, 3, ts );
			if( tile === '13' ) {
				context.fillRect( x*ts+8+1, y*ts, 3, ts-8 );
			}
			if( tile === '14' ) {
				context.fillRect( x*ts+8+1, y*ts+8+1, 3, ts-8 );
			}
			if( tile === '2' ) {
				context.fillRect( x*ts+8+1, y*ts+8+1, 26, 3 );
				context.fillRect( x*ts+8+1, y*ts, 3, 25 );
			}
			if( tile === '3' ) {
				context.fillRect( x*ts, y*ts+8+1, 25, 3 );
				context.fillRect( x*ts+8+1, y*ts, 3, 25 );
			}
			if( tile === '4' ) {
				context.fillRect( x*ts+8+1, y*ts+8+1, 26, 3 );
				context.fillRect( x*ts+8+1, y*ts+8+1, 3, 26 );
			}
			if( tile === '5' ) {
				context.fillRect( x*ts, y*ts+8+1, 25, 3 );
				context.fillRect( x*ts+8+1, y*ts+8+1, 3, 26 );
			...
			if( tile === '6' ) {
				context.fillRect( x*ts, y*ts+8+1, ts, 3 );
				context.fillRect( x*ts+8+1, y*ts, 3, 25 );
			}
			if( tile === '7' ) {
				context.fillRect( x*ts, y*ts+8+1, ts, 3 );
			...
			if( tile === '8' ) {
				context.fillRect( x*ts+8+1, y*ts+8+1, 26, 3 );
				context.fillRect( x*ts+8+1, y*ts, 3, ts );
			}
			if( tile === '9' ) {
				context.fillRect( x*ts, y*ts+8+1, 25, 3 );
				context.fillRect( x*ts+8+1, y*ts, 3, ts );
